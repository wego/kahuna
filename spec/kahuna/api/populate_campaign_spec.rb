...
describe Kahuna::Api::PopulateCampaign do
  ...
  describe '#validate' do
    context 'campaign_id' do
      ...
      it 'raises error if missing' do
        expect {
          Kahuna::Api::PopulateCampaign.new(campaign_id: 'not integer', cred_type: 'email', default_params: { today: '2015-03-13', breakfast: 'waffles' }, recipient_list: [{ k_to: [ 'yc@gmail.com' ], breakfast: 'bread' }])
        }.to(raise_error(Kahuna::ArgumentError, 'campaign_id should be an integer'))
      end
    end
